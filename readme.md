...
- [x] [consecutive-strings](./6kyu/4.consecutive-strings/)
- [x] [break-camelcase](./6kyu/5.break-camelcase/)
- [x] [highest-scoring-word](./6kyu/6.highest-scoring-word/)
- [ ] [sort-the-odd](./6kyu/7.sort-the-odd/)

# 7kyu
- [x] [sum-of-triangular-numbers](./7kyu/0.sum-of-triangular-numbers/)
- [x] [1.vowel-count](./7kyu/1.vowel-count/)
- [x] [ones-and-zeros](./7kyu/2.ones-and-zeros/)
- [x] [form-the-minimum](./7kyu/3.form-the-minimum/)
- [x] [string-ends-with](./7kyu/4.string-ends-with/)
- [x] [tidy-number](./7kyu/5.tidy-number/)

# 8kyu
- [x] [welcome](./8kyu/0.welcome/)
- [x] [exclamation-marks](./8kyu/1.exclamation-marks/)
- [x] [square-sum](./8kyu/2.square-sum/)
- [x] [reversed-string](./8kyu/3.reversed-string/)